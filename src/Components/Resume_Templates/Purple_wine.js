...
const Purple_Wine=(props)=>
{
    ...
    return(<>
            ...
            <div id="purple_wine" class=" templates  border-2 rounded-[5px] border-[#d400ff] relative   mx-[auto] max-w-[700px]">
            {pathname==="/preview-template" ? "" :  pathname==="/my-resume" ? "" :<TemplateHover template_val="purple_wine" />}
            <div  className=" bg-[#d400ff]  w-[100%] grid grid-cols-12  ">
               {/* profile image */}
               <img alt="profile" src={dummydata.profile} className=" p-[5px]  rounded-[1000px] col-span-3 w-[100px] h-[100px]"/>
               {/* big-name */}
               ...
               <div className="col-span-3 self-center text-[10px] text-white font-[700]">
                ...
                {/* experience div */}
                <div > 
                <p class="text-[#d400ff] text-[20px] p-[20px] font-[900] py-[10px]">PROFFESSIONAL EXPERIENCE</p>
                    <hr class="border-[#d400ff] border-[2px] px-[10px]"/>
                    {
                        dummydata.experience.map((e)=>
                        {
                ...
                <p class="text-[#d400ff] text-[20px] p-[20px] font-[900] py-[10px]">Education</p>
                <hr class="border-[#d400ff] border-[2px]  "/>
                    <table>
                        <tr>
                            <th>Type</th>
                            <th>University</th>
                ...
                <p class="text-[#d400ff] text-[20px] p-[20px] font-[900] py-[10px]">SKILLS</p>
                <hr class="border-[#d400ff] border-[2px]  "/>
