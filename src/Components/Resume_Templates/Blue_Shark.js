...
{    
    ...
    return(<>
            ...
            <div id="bule_shark" class="  templates  relative border-2 rounded-[5px] border-[#00eeff]  mx-[auto] max-w-[700px]">
            {pathname==="/preview-template" ? "" :  pathname==="/my-resume" ? "" :<TemplateHover template_val="blue_shark" />}
               
            <div  className=" bg-[#00eeff]  w-[100%] grid grid-cols-12  ">
               {/* profile image */}
               ...
               <div className="col-span-3 self-center text-[10px] text-white font-[700]">
                ...
                {/* experience div */}
                <div > 
                <p class="text-[#00eeff] text-[20px] p-[20px] font-[900] py-[10px]">PROFFESSIONAL EXPERIENCE</p>
                    <hr class="border-[#00eeff] border-[2px] px-[10px]"/>
                    {
                ...
                <p class="text-[#00eeff] text-[20px] p-[20px] font-[900] py-[10px]">Education</p>
                <hr class="border-[#00eeff] border-[2px]  "/>
                    <table>
                        <tr>
                            <th>Type</th>
                            <th>University</th>
                ...
                <p class="text-[#00eeff] text-[20px] p-[20px] font-[900] py-[10px]">SKILLS</p>
                <hr class="border-[#00eeff] border-[2px]  "/>
